...
const makeStyles = (c: ColorPalette) =>
  StyleSheet.create({
    ...
    tabsScroll: { borderBottomWidth: 1, borderBottomColor: c.border, flexShrink: 0, flexGrow: 0 },
    tabsContent: { paddingHorizontal: Space.screen, paddingTop: 10, gap: 4 },
    tab: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 6,
    ...
    tabCount: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 6 },
    list: { flex: 1 },
    listContent: { padding: Space.screen, paddingTop: 14, gap: 8 },
    toolCard: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 12,
    ...
    stripe: { width: 4, alignSelf: 'stretch', borderRadius: 2, marginLeft: 0 },
    toolIcon: {
      width: 42,
      height: 42,
      borderRadius: 12,
    ...
    toolInfo: { flex: 1 },
    toolNameRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    tagBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, flexShrink: 0 },
  });
            ...
            <Pressable
              ...
              <View style={[styles.tabCount, { backgroundColor: `${sport.color}22` }]}>
                <AppText
                  ...
                  weight="black"
                  size={10}
                  color={active ? sport.color : colors.textDim}
                  uppercase>
                  {count}
                </AppText>
              </View>
